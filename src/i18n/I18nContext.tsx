...
const translations: Record<Lang, Dict> = {
  es: {
    ...
    "btn.chat": "Chat IA",
    "btn.library": "Mi librería",
    "lib.title": "MI LIBRERÍA",
    "lib.all": "Todos",
    "lib.liked": "Me gustó",
    "lib.read": "Leído",
    "lib.empty": "Tu librería está vacía. Marca libros como 'me gustó' o 'leído' desde su ficha.",
    "lib.markLiked": "Me gustó",
    "lib.markRead": "Marcar como leído",
    "note.heading": "MIS NOTAS",
    "note.rating": "Tu puntuación:",
    "note.placeholder": "¿Qué te pareció? Personajes favoritos, momentos, opinión...",
    "note.save": "Guardar",
  ...
  en: {
    ...
    "lib.liked": "Liked",
    "lib.read": "Read",
    "lib.empty": "Your library is empty. Mark books as 'liked' or 'read' from their page.",
    "lib.markLiked": "I liked it",
    "lib.markRead": "Mark as read",
    "note.heading": "MY NOTES",
    "note.rating": "Your rating:",
    "note.placeholder": "What did you think? Favorite characters, moments, opinion...",
    "note.save": "Save",
